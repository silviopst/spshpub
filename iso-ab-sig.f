...
C     READ(5,200) ((R(I,J),I=1,N),J=1,N)
      ...
      READ(1,200) ((P(I,J),I=1,N),J=1,N)
        CLOSE(1)
      open (unit = 2, file = 'c:\\G77\\OUT-ISO-AB.TXT')
      PRINT 300
      WRITE(2, 300)
      ALF='Q'
	  PRINT 310, ALF, Q
...
C
 200	FORMAT(10I2)
 210	FORMAT(1H1,10X, 'Q ED P NON SONO ISOMORFI <ALFA,BETA,ID>',
     $  //,10X,'ELABORAZIONE TERMINATA.')
 220	FORMAT(1H1, 10X,'Q ED R SONO ISOMORFI <ALFA, BETA>',//,10X,
     $  'LA PERMUTAZIONE ALFA ', 2HE',' LA SEGUENTE :')
 230	FORMAT(1H0, //,10X,'ELABORAZIONE TERMINATA.')
c 240	FORMAT(1H0, //,(35X,I5,4H -->  , I5//))
